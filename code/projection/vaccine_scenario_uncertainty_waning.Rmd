---
title: "vaccine_scenario_uncertainty_waning"
...
```{r}
# path_to_model <-  here("projection", "model_vaccine_waning.R") 
...
# print(i)
  ...
  out_parallel <- foreach(j =  1:n_vac_age, .combine = rbind) %dopar% {
...
saveRDS(list(coverage = v_coverage, 
             ...
             output=results_list), 
        file = "model_output/model_vcov_0p7_nsamp_50.rds")
