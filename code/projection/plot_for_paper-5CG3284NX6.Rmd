...
## Percentage of hospitalization averted
...
## Cases averted stratified with baseline serostatus
...
get_arranged_plot_averted_serostatus <- function(set_of_rds_files, variable_name, y_lab, t_begin, t_end) {
  ...
  write.table(combined_summary,
            file = here::here("output_estimate_figure", "symp_serop_seron_perc.txt"),
            sep = "\t",
            row.names = FALSE,
            quote = FALSE)
...
figure_name <- "symp_serop_seron_perc.jpg"
...
## Hospitalizations averted stratified with baseline serostatus
```{r}
get_agg_over_age <- function(arr) {
  arr_agg_age <- apply(arr, c(1,2,4), sum)
  return(arr_agg_age)
...
get_plot_averted_serostatus <- function(df_total, df_seroneg, df_seropos, y_limits, y_breaks) {
  ...
  # # Define colors for different vaccine coverages
  # poptype_barcolors <- c("All" = "#7570b3", "Seronegative" = "#d95f02", "Seropositive" = "#679f3e")
  # 
  # poptype_errorbar_colors <- c("All" = "#4a3e77", "Seronegative" = "#993e01", "Seropositive" = "#3d5e25")
  # 
  # Define the dodge position for side-by-side plotting
  dodge <- position_dodge(width = 0.3)
...
get_arranged_plot_averted_serostatus <- function(set_of_rds_files, variable_name, y_lab, t_begin, t_end) {
  ...
  write.table(combined_summary,
            file = here::here("output_estimate_figure", "hosp_serop_seron_perc.txt"),
            sep = "\t",
            row.names = FALSE,
            quote = FALSE)
...
figure_name <- "hosp_serop_seron_perc.jpg"
...
### cases averted  With vs without efficacy against infection
```{r}
get_agg_over_age <- function(arr) {
  arr_agg_age <- apply(arr, c(1,2,4), sum)
  return(arr_agg_age)
...
get_arranged_plot_averted_with_without_effi_inf <- function(set_of_rds_files, variable_name, y_lab, t_begin, t_end) {
  ...
  write.table(combined_summary,
            file = here::here("output_estimate_figure", "symp_dom_sero_effi_inf.txt"),
            sep = "\t",
            row.names = FALSE,
            quote = FALSE)
...
figure_name <- "symp_dom_sero_effi_inf.jpg"
...
### Hospitalizations averted  With vs without efficacy against infection
```{r}
get_agg_over_age <- function(arr) {
  arr_agg_age <- apply(arr, c(1,2,4), sum)
  return(arr_agg_age)
...
get_arranged_plot_averted_with_without_effi_inf <- function(set_of_rds_files, variable_name, y_lab, t_begin, t_end) {
  ...
  write.table(combined_summary,
            file = here::here("output_estimate_figure", "hosp_dom_sero_effi_inf.txt"),
            sep = "\t",
            row.names = FALSE,
            quote = FALSE)
...
figure_name <- "hosp_dom_sero_effi_inf.jpg"
...
### Impact of Prescreening on cases
...
get_averted_screening <- function(nv_output, v_output,  t_begin, t_end){
  ...
  averted_screening <- 100*(nv_cum_t - v_cum_t)/nv_cum_t    #100*(nv_cum_t - v_cum_t)/nv_cum_t 
...
## List all the datasets that we want to plot together
set_of_rds_files <- list(
  c("pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds"),  # Set 1

 c("pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds"), # Set 2
 
 c("pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds"), # Set 3
 
 c("try_pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "try_pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_1.rds",
    "try_pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds",
    "try_pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_non_sero_0.rds") # set 4
)
...
custom_y_limits2 <- c(0, 30)
custom_y_breaks2 <- seq(0, 30, by = 6)

# Custom y-axis settings for a specific figure (for negative impact)(change it accordingly)
custom_y_limits3 <- c(0,30)
custom_y_breaks3 <- seq(0, 75, by = 6)

custom_y_limits4 <- c(-40, 30)
custom_y_breaks4 <- seq(-40, 30, by = 10)
...
figure_name <- "percent_symp_averted_screening_population_test_coverage_1.jpg"
...
### Impact of Prescreening on hospitalizations
...
## List all the datasets that we want to plot together
set_of_rds_files <- list(
  c("pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv1_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds"),  # Set 1

 c("pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv2_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds"), # Set 2
 
 c("pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv3_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds"), # Set 3
 
 c("pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_1.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_yes_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds",
    "pri_sec_neq_detailed_a7_sero_dom_denv4_vcov_0.8_baseline_no_nsamp_100_waning_0_prescrng_1_prescrenning_same_vac_0.rds") # set 4
)
...
custom_y_limits1 <- c(0, 40)
custom_y_breaks1 <- seq(0, 40, by = 10)

custom_y_limits2 <- c(0, 40)
custom_y_breaks2 <- seq(0, 40, by = 10)

# Custom y-axis settings for a specific figure (for negative impact)(change it accordingly)
custom_y_limits3 <- c(0, 40)
custom_y_breaks3 <- seq(0, 40, by = 10)

custom_y_limits4 <- c(-10, 40)
custom_y_breaks4 <- seq(-10, 40, by = 10)
...
figure_name <- "percent_hosp_averted_screening_population_test_coverage.jpg"
