...
## Symptomatic 
```{r}
nv_symp <- extract_variable(rds_file = "test_model_vcov_0_nsamp_20_lb_-0.25_ve_scenario1.rds" , 
                            variable_name = "symp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "symp_sample_age_v")

v_symp_20 <- extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "symp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "symp_sample_age_v")

v_symp_50 <- extract_variable(rds_file = "test_model_vcov_0.5_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "symp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.5_nsamp_20_lb_-0.25_ve_scenario1.rds",
                            variable_name = "symp_sample_age_v")

v_symp_80 <- extract_variable(rds_file = "test_model_vcov_0.8_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "symp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.8_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "symp_sample_age_v")
...
## Infection 
```{r}
nv_inf <- extract_variable(rds_file = "test_model_vcov_0_nsamp_50_lb_-0.25_ve_scenario1.rds" , 
                            variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0_nsamp_50_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "inf_sample_age_v")

v_inf_20 <- extract_variable(rds_file = "test_model_vcov_0.2_nsamp_50_lb_-0.25_ve_scenario1.rds",
                              variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.2_nsamp_50_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "inf_sample_age_v")

v_inf_50 <- extract_variable(rds_file = "test_model_vcov_0.5_nsamp_50_lb_-0.25_ve_scenario1.rds",
                              variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.5_nsamp_50_lb_-0.25_ve_scenario1.rds",
                            variable_name = "inf_sample_age_v")

v_inf_80 <- extract_variable(rds_file = "test_model_vcov_0.8_nsamp_50_lb_-0.25_ve_scenario1.rds",
                              variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.8_nsamp_50_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "inf_sample_age_v")
...
## hospitalization
```{r}
nv_hosp <- extract_variable(rds_file = "test_model_vcov_0_nsamp_20_lb_-0.25_ve_scenario1.rds" , 
                            variable_name = "hosp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "hosp_sample_age_v")

v_hosp_20 <- extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "hosp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "hosp_sample_age_v")

v_hosp_50 <- extract_variable(rds_file = "test_model_vcov_0.5_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "hosp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.5_nsamp_20_lb_-0.25_ve_scenario1.rds",
                            variable_name = "hosp_sample_age_v")

v_hosp_80 <- extract_variable(rds_file = "test_model_vcov_0.8_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "hosp_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.8_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "hosp_sample_age_v")
...
total_pop_age <- extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "tot_pop_sample_age")

v_vac_age_20 <- extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds",
...
v_symp_20_age <- get_agg_over_diff_age(arr = v_symp_20, age_division = v_a)
nv_symp_age_agg <- apply(nv_symp_age[, , ,10:30], c(1, 2,3), sum)
v_symp_20_age_agg <- apply(v_symp_20_age[, , ,10:30], c(1, 2,3), sum)
