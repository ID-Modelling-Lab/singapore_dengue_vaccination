...
## Infection 
```{r}
nv_inf <- extract_variable(rds_file = "test_model_vcov_0_nsamp_20_lb_-0.25_ve_scenario1.rds" , 
                            variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "inf_sample_age_v")

v_inf_20 <- extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.2_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "inf_sample_age_v")

v_inf_50 <- extract_variable(rds_file = "test_model_vcov_0.5_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.5_nsamp_20_lb_-0.25_ve_scenario1.rds",
                            variable_name = "inf_sample_age_v")

v_inf_80 <- extract_variable(rds_file = "test_model_vcov_0.8_nsamp_20_lb_-0.25_ve_scenario1.rds",
                              variable_name = "inf_sample_age") + 
           extract_variable(rds_file = "test_model_vcov_0.8_nsamp_20_lb_-0.25_ve_scenario1.rds", 
                            variable_name = "inf_sample_age_v")
...
get_agg_over_diff_age <- function(arr) {
