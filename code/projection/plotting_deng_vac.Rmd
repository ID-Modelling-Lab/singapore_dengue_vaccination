...
# baseline
model_projection_v0 <- readRDS(here::here("model_output", "model_vcov_0p0_nsamp_20_veseron_zero_0.rds") )
# specific vaccine coverage
model_projection_v20 <- readRDS(here::here("model_output", "model_vcov_0p2_nsamp_20_veseron_zero_0.rds") )
model_projection_v50 <- readRDS(here::here("model_output", "model_vcov_0p5_nsamp_20_veseron_zero_0.rds") )
model_projection_v80 <- readRDS(here::here("model_output", "model_vcov_0p8_nsamp_20_veseron_zero_0.rds") )
