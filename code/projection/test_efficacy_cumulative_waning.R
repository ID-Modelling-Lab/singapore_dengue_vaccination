...
# print( waning_symp_n_stage)

### for loop over n_vac_stage
...
# v_eff <- get_final_stage_conditional_ve(symp_low_sero_n =  pt_lb_ub$symp_low_sero_n,
...
effi_inf_sero_n_sample = array(NA, dim = c(n_run, n_vac_stage))
effi_inf_sero_p_sample = array(NA, dim = c(n_run, n_vac_stage))
...
for (i in 1:n_run) {
  ...
  effi_inf_sero_n = v_eff$cnd_inf_n
  effi_inf_sero_p = v_eff$cnd_inf_p
  ...
  effi_inf_sero_n_sample[i,] = effi_inf_sero_n
  effi_inf_sero_p_sample[i,] = effi_inf_sero_p
...
par(mfrow = c(2, 2))  # 2 rows and 2 columns
  ...
  vioplot(effi_inf_sero_n_sample,
          main = "Inf (sero-)",
          xlab = "Stage",
          ylab = "VE")

  vioplot(effi_inf_sero_p_sample,
          main = "Inf (sero+)",
          xlab = "Stage",
          ylab = "VE")
...
for (i in 1:4) {
  ...
  vioplot(effi_symp_sero_n_sample[,,i],
          main = paste("VCD (sero-) DEN", i),
          xlab = "Stage",
          ylab = "VE")
}
...
for (i in 1:4) {
  ...
  vioplot(effi_symp_sero_p_sample[,,i],
          main = paste("VCD (Sero+) DEN", i), 
          xlab = "Stage", 
          ylab = "VE")
}
...
for (i in 1:4) {
  ...
  vioplot(effi_hos_sero_n_sample[,,i],
          main = paste("Hosp (seo-) DEN", i),
          xlab = "Stage",
          ylab = "VE")
}
...
for (i in 1:4) {
  ...
  vioplot(effi_hos_sero_p_sample[,,i],
          main = paste("Hosp (Sero+) DEN", i), 
          xlab = "Stage", 
          ylab = "VE")
}
