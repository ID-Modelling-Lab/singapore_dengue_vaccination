...
All the codes are written in `R (Version: R-4.3.1)`. The libraries required to run the codes are including : [odin](https://mrc-ide.github.io/odin/), [dust](https://mrc-ide.github.io/dust/index.html), [odin.dust](https://mrc-ide.github.io/odin.dust/index.html), [mcstate](https://mrc-ide.github.io/mcstate/index.html). 
